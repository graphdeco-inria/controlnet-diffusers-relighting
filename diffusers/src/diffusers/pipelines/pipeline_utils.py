...
class DiffusionPipeline(ConfigMixin, PushToHubMixin):
    ...
    def progress_bar(self, iterable=None, total=None, disable=False):
        ...
        if iterable is not None:
            return tqdm(iterable, disable=disable, **self._progress_bar_config)
        elif total is not None:
            return tqdm(total=total, disable=disable, **self._progress_bar_config)
        else:
